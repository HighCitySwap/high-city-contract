...
contract HCCToken is ERC20, Ownable {
    ...
    address public _stakeRewardPool;
    uint256 public _fee; // fee for each transaction
    uint256 public _maxRewardFee = 5000 * 1e18;
    uint256 public _remainingRewardFee = 0;
    DividendRatio public _dividendRatio;
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    event DividendRatioChange(uint256 teamRewardRatio, uint256 nftOwnerRewardRatio, uint256 BODRewardRatio, uint256 stakeRewardRatio, uint256 changeTime);
    constructor(
    ...
    function addMinter(address _addMinter) public onlyOwner returns (bool) {
        require(_addMinter != address(0), "BoxToken: _addMinter is the zero address");
        return EnumerableSet.add(_minters, _addMinter);
    }

    function delMinter(address _delMinter) public onlyOwner returns (bool) {
        require(_delMinter != address(0), "BoxToken: _delMinter is the zero address");
    ...
    function getMinter(uint256 _index) public view onlyOwner returns (address){
        require(_index <= getMinterLength() - 1, "BoxToken: index out of bounds");
